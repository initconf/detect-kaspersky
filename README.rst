...
Installation
------------
        zeek-pkg install zeek/initconf/detect-kaspersky
        or
...
2) Kaspersky::URL - Note this alert will only fire if a new URL (not seen in scripts/kaspersky_urls.zeek ) is seen.
